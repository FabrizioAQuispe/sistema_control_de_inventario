    ...
    return (
        <nav className='bg-blue-700 w-[200px] h-screen px-5 py-10'>
            ...
            <ul className='space-y-2'>
                <li><Link className='px-2 py-2 block text-white hover:bg-indigo-800 rounded-md' href={'/admin/Inicio'}>Inicio</Link></li>
                ...
                <li><a 
                className='px-2 py-2 block text-white hover:bg-indigo-800 rounded-md'
                onClick={() => {
                    deleteCookie("data")
